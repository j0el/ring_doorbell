...
class Location extends subscribed_1.Subscribed {
    ...
    onDataUpdate = new rxjs_1.Subject();
    onDeviceDataUpdate = this.onDataUpdate.pipe((0, operators_1.filter)((message) => {
    ...
    onDeviceList = this.onMessage.pipe((0, operators_1.filter)((m) => m.msg === deviceListMessageType));
    onDevices = this.onDeviceList.pipe((0, operators_1.scan)((devices, { body: deviceList, src }) => {
        if (!deviceList) {
            return devices;
        }
    ...
    onSessionInfo = this.onDataUpdate.pipe((0, operators_1.filter)((m) => m.msg === 'SessionInfo'), (0, operators_1.map)((m) => m.body));
    onConnected = new rxjs_1.BehaviorSubject(false);
    onLocationMode = new rxjs_1.ReplaySubject(1);
    onLocationModeRequested = new rxjs_1.Subject();
    reconnecting = false;
    disconnected = false;
    connectionPromise;
    securityPanel;
