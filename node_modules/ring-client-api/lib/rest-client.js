...
const fetchAgent = new undici_1.Agent({
    connections: 6,
    pipelining: 1,
    ...
    try {
        ...
        if (!e.response && !requestOptions.allowNoResponse) {
            if (retryCount > 0) {
                ...
                (0, util_1.logError)(`Retry #${retryCount} failed to reach Ring server at ${requestOptions.url}.  ${detailedError}.  Trying again in 5 seconds...`);
...
class RingRestClient {
    ...
    using2fa = false;
    promptFor2fa;
    onRefreshTokenUpdated = new rxjs_1.ReplaySubject(1);
    onSession = new rxjs_1.ReplaySubject(1);
    baseSessionMetadata;
    constructor(authOptions) {
        ...
        this.hardwareIdPromise =
            this.authConfig?.hid || (0, util_1.getHardwareId)(authOptions.systemId);
