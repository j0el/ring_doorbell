...
export declare class RingCamera extends Subscribed {
    ...
    getNextSnapshot({ afterMs, maxWaitMs, force, uuid, }: {
        ...
        force?: boolean;
        uuid?: string;
    }): Promise<Buffer<ArrayBufferLike> & import("./rest-client").ExtendedResponse>;
    getSnapshotByUuid(uuid: string): Promise<Buffer<ArrayBufferLike> & import("./rest-client").ExtendedResponse>;
