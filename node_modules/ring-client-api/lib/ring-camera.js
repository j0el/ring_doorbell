...
class RingCamera extends subscribed_1.Subscribed {
    ...
    hasLight;
    hasSiren;
    onRequestUpdate = new rxjs_1.Subject();
    onNewNotification = new rxjs_1.Subject();
    onActiveNotifications = new rxjs_1.BehaviorSubject([]);
    onDoorbellPressed = this.onNewNotification.pipe((0, operators_1.filter)((notification) => notification.android_config.category === ring_types_1.PushNotificationAction.Ding), (0, operators_1.share)());
    onMotionDetected = this.onActiveNotifications.pipe((0, operators_1.map)((notifications) => notifications.some((notification) => notification.android_config.category ===
    ...
    onMotionStarted = this.onMotionDetected.pipe((0, operators_1.filter)((currentlyDetected) => currentlyDetected), (0, operators_1.map)(() => null), // no value needed, event is what matters
    (0, operators_1.share)());
    onBatteryLevel;
