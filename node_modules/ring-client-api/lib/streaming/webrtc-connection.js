...
class WebrtcConnection extends subscribed_1.Subscribed {
    camera;
    onSessionId = new rxjs_1.ReplaySubject(1);
    onOfferSent = new rxjs_1.ReplaySubject(1);
    dialogId = (0, util_1.generateUuid)();
    onCameraConnected = new rxjs_1.ReplaySubject(1);
    onCallAnswered = new rxjs_1.ReplaySubject(1);
    onCallEnded = new rxjs_1.ReplaySubject(1);
    onError = new rxjs_1.ReplaySubject(1);
    onMessage = new rxjs_1.ReplaySubject();
    onWsOpen;
    onAudioRtp;
    onVideoRtp;
    pc;
