...
const _1 = require(".");
const __1 = require("../../..");
const extra_1 = require("../../../../../rtp/src/extra");
...
class WebmFactory extends _1.MediaWriter {
    ...
    async start(tracks) {
        ...
        const webm = new extra_1.WebmCallback(inputTracks, {
        ...
        this.rtpSources = inputTracks.map(({ track, clockRate, codec }) => {
            ...
            const time = this.props.disableNtp
                ? new extra_1.RtpTimeCallback(clockRate)
                : new extra_1.NtpTimeCallback(clockRate);
            if (track.kind === "video") {
        ...
        if (this.props.path) {
            webm.pipe((0, extra_1.saveToFileSystem)(this.props.path));
        }
